...
\item
Verify the output of the above transfer using a python code

\solution


\begin{itemize}
\item In the real life oscillator generates a sinusoidal input utilizing the thermal noise in the circuit.
\item In the python simulation, oscillator requires an input to generate the output as there is no thermal noise in the simulation.
\item Any input will produce the same sinusoidal output in the simulation as you can see output for both step input and impulse input is same(Amplitude might differ but frequency will be the same). 
\item Please refer Fig{\ref{fig:ee18btech11044_3_4}} for the output of the transfer function for a step input.
\item Please refer Fig{\ref{fig:ee18btech11044_3_5}} for the output of the transfer function for am impulse input.
\item Code for generating step response
\begin{lstlisting}
codes/ee18btech11044/ee18btech11044_pyst.py
\end{lstlisting}
\item Code for generating impulse response
\begin{lstlisting}
codes/ee18btech11044/ee18btech11044_pyim.py
\end{lstlisting}
\end{itemize}
...
\begin{lstlisting}
spice/ee18btech11044/ee18btech11044_spice.py
\end{lstlisting}
